...
const NewsletterSection = () => {
  return (
    <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-16" id = "newsletter">
      <div className="bg-gradient-to-r from-indigo-600 to-purple-600 rounded-2xl overflow-hidden relative">
        {/* === Slanted Gradient Background for Right Half === */}
        <div className="absolute top-0 right-0 w-1/2 h-full hidden md:block z-0">
          <div className="w-full h-full bg-gradient-to-r from-indigo-600 to-purple-600 clip-slant"></div>
        </div>
  ...
  />
  <button
    className="bg-purple-900 text-white px-6 sm:px-8 py-3 sm:py-4 
