      ...
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-12 items-center min-h-[calc(100vh-8rem)]">
        <div className="space-y-8">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <button className="bg-gradient-to-r from-indigo-600 to-purple-600 text-white px-8 py-4 rounded-lg text-lg font-semibold hover:-translate-y-0.5 hover:shadow-xl hover:shadow-indigo-500/30 transition-all">
              Start Collaborating
            </button>
